...
PICS = (environ.get('PICS', 'https://envs.sh/WiD.jpg')).split() #SAMPLE PIC
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '84744568aeedbab8267a2aad1f77ef2e49821879')
